...
/src目录包含了LibDriver HDC1080的源文件。

/interface目录包含了LibDriver HDC1080与平台无关的IIC总线模板。

/test目录包含了LibDriver HDC1080驱动测试程序，该程序可以简单的测试芯片必要功能。

/example目录包含了LibDriver HDC1080编程范例。

/doc目录包含了LibDriver HDC1080离线文档。

/datasheet目录包含了HDC1080数据手册。
...
在线文档: [https://www.libdriver.com/docs/hdc1080/index.html](https://www.libdriver.com/docs/hdc1080/index.html)。
